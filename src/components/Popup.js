    ...
    return (
      <div className="popup">
        <div className="popup-winner">
          ...
          <button onClick={handleQuit} className="btn-1 btn-quit bg-secondary-300 fs-200 fw-bold"></button>
          <button onClick={handleNextRound} className="btn-2 btn-next-round bg-primary-300 fs-200 fw-bold"></button>
        </div>
      </div>
    );
  }
