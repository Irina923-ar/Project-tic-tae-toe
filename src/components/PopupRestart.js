      ...
      <div className="popup-container">
        <div>
          ...
          <div className="bg-secondary-200">
            <button onClick={() => setShowPopup(false)} className="btn-1 btn-restart-1 bg-secondary-300 fs-200 fw-bold">
              NO, CANCEL
            </button>
            <button onClick={() => restartGame(false)} className="btn-2 btn-restart-2 bg-primary-300 fs-200 fw-bold">
              YES, RESTART
            </button>
          </div>
        </div>
